...
const Footer = () => {
  return (
    <footer className='bg-[#242a38] px-10 gap-5 xl:px-30 py-4 flex flex-col xl:flex-row
  ...
  rel="noopener noreferrer">
    <button className="btn  bg-gray-700 hover:bg-gray-800  btn-circle mr-3">
  ...
  rel="noopener noreferrer">
    <button className="btn  bg-gray-700 hover:bg-gray-800  btn-circle mr-3">
      ...
      <button className="btn  bg-gray-700 hover:bg-gray-800  btn-circle mr-3">
         <IoLogoWhatsapp size='15' className="text-white" />
      </button>
      </a>
