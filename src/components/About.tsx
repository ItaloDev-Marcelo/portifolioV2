...
const About = () => {
  return (
    <section id='Sobre' className="flex flex-col xl:flex-row items-center xl:justify-evenly justify-center dark:bg-gray-900 px-6 md:px-7 py-19 bg-[#feffff]">
       <div className="mb-9"><figure>
          <img src={profilePhoto} className='rounded-md w-50 xl:w-62.5' alt='foto de perfil de Italo-marcelo'/>
       </figure></div>
       <div className="flex flex-col gap-5 xl:gap-y-1  xl:w-[60%]">
        ...
        <p className='text-[1em] px-10 xl:px-0 md:text-[1.3em] xl:text-[1.1em] xl:w-[99%] '>Sou desenvolvedor frontend com foco em criar interfaces modernas, acessiveis e performáticas. Gosto de aprender coisas novas e transformar ideias em soluções reais.</p>
         </div>
