...
const Footer = () => {
  return (
    <footer className='bg-[#242a38] dark:bg-gray-900 px-10 gap-5 xl:px-30 py-4 flex flex-col xl:flex-row
  ...
  rel="noopener noreferrer">
    <button className="btn  bg-gray-700 hover:bg-gray-800 dark:bg-white  btn-circle mr-3">
        <FaGithub size='15' className="text-white dark:text-black"/>
      </button>
  </a>
  ...
  rel="noopener noreferrer">
    <button className="btn  bg-gray-700 hover:bg-gray-800 dark:bg-white  btn-circle mr-3">
         <FaLinkedinIn size='15' className="text-white dark:text-black"/>
      </button>
  </a>
      
      <a href="https://wa.me/5573981339671?text=Olá,%20gostaria%20de%20falar%20com%20você.">
      <button className="btn  bg-gray-700 hover:bg-gray-800 dark:bg-white  btn-circle mr-3">
         <IoLogoWhatsapp size='15' className="text-white dark:text-black"  />
      </button>
      </a>
